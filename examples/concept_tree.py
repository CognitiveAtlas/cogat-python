...
# EXAMPLE 2: #########################################################
# We are going to make a tree for all cognitive concepts
######################################################################
...
# This is a bug that needs to be fixed in pybraincompare to remove unicode, we can fix manually here
for column in relationship_table.columns:
    relationship_table[column] = [str(x) for x in relationship_table[column].tolist()]
